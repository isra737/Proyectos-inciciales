...
public static void main(String[] args) {
 ...
 for (i=0; i<=4; i++) { 
    ...
    // Primero evaluamos si se ha acertado.
    
    if (a == b) {  
      System.out.println("¡Has acertado!"); 
      break; } 
    
    // Luego se dara la partdia por perdida si lo haz intentado 5 veces
    
    else if (i == 4) { 
      System.out.println("Lo siento: ¡has perdido!. El número era el: " + a); 
      break; } 
    
    // Si no es ninguno de los casos, comparamos los números.
